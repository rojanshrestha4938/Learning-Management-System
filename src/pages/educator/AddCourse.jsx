...

            {
              showPopup && (
                <div className='fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50'>
                  <div className='bg-white rounded-lg p-6 w-96 max-h-screen overflow-y-auto relative'>
                    <button onClick={()=>setShowPopup(false)} className='absolute top-4 right-4 text-gray-400 hover:text-gray-600 text-xl'>✕</button>
                    
                    <h2 className='text-xl font-semibold text-gray-800 mb-6'>Add Lecture</h2>
                    ...
                    <div className='space-y-5'>
                      ...
                      <div className='flex items-center gap-2 pt-2'>
                        ...
                        />
                        <label htmlFor='previewFree' className='text-sm font-medium text-gray-700 cursor-pointer'>Is Preview Free?</label>
                      </div>
                    </div>
                    
                    <button type='button' 
                      className='w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2.5 rounded-lg mt-6 transition-colors' onClick={addLecture}>
                        Add</button>
                  </div>
                </div>
              )
