...
const CourseDetail = () => {
  ...
  const {allCourses,calculateRating,calculateChapterTime, calculateCourseDuration, calculateNoofLectures,currency}=React.useContext(AppContext)
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='pt-4 md:text-base text-sm'
           ...
           <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                       ...
                       <p className='text-blue-600'>({courseData.courseRatings && Array.isArray(courseData.courseRatings) ? courseData.courseRatings.length : 0} 
                        {(courseData.courseRatings && Array.isArray(courseData.courseRatings) && courseData.courseRatings.length>1) ? ' ratings' : ' rating'})</p>
                        <p>
                          {courseData.enrolledStudents && Array.isArray(courseData.enrolledStudents) ? courseData.enrolledStudents.length : 0}
                          {(courseData.enrolledStudents && Array.isArray(courseData.enrolledStudents) && courseData.enrolledStudents.length>1) ? ' students enrolled' : ' student enrolled'}
                        </p>
                     </div>
                     <p className='text-sm'>Course by <span className='text-blue-600 underline'>GreatSrack</span></p>
